classdef LightGateLegacy
    ...
    methods
        function obj = LightGateLegacy(inputargs)
            arguments
        ...
        function obj = FitLightGate(obj,inputargs)
            ...
            LightGateFitPath = split(obj.RawData.FilePath,'.');
            LightGateFitPath = [LightGateFitPath{1},'_LightGateFit.mat'];
            ...
            if ~isfile(LightGateFitPath)
                ...
                [obj.FittedCurve, ~] = fit(xData,...
                                           ...
                                           fittype('a*erfc(b*(x-c))+d',...
                                                   ...
                                                   'y'),...
                                           opts );
                FittedCurve = obj.FittedCurve; %#ok<PROPLC> 
                save(LightGateFitPath,'FittedCurve','-v7.3')
            else
                LightGateFitPath = load(LightGateFitPath,'FittedCurve');
                obj.FittedCurve = LightGateFitPath.FittedCurve;
            end
